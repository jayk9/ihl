...
<!-- Mirrored from sporty.wp4life.com/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Jun 2016 04:14:19 GMT -->
<head>
        ...
        <link href="css/ytv.css" rel="stylesheet" type="text/css">
    ...
    <body>
        ...
        <section class="maincontainer">
            ...
            <div class="clear"></div>
            <!-- FIXTURE TITLE -->
            <div class="scores-title ytv-below">Upcoming Matches & Latest Results</div>
            <!-- FIXTURE SLIDER -->
        ...
        <script type="text/javascript">
            jQuery(document).ready(function() {
                jQuery('#youtube-wrapper').ytv({
                    ...
                    maxplaylist: 20, // Max number of playlist
                    maxinplaylist: 50, // Max video in the playlist
					controls: true,
					autoplay: false
				});
            });
...
<!-- Mirrored from sporty.wp4life.com/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Jun 2016 04:14:21 GMT -->
</html>