...
<!-- Mirrored from sporty.wp4life.com/fixtures.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Jun 2016 04:14:36 GMT -->
<head>
                    ...
                    <div class="resp-tabs-container">
                        <div>
                            <div class="sidebarbox-title">
                                <h3>Fixture and Results / 2013-2014</h3>
                            </div>
                        <!-- TABLE -->
                        ...
                        <div>
                            <div class="sidebarbox-title">
                                <h3>Fixture and Results / 2012-2013</h3>
                            </div>
                        <!-- TABLE -->
                        <div class="fixture-row">
                            <a href="result.html">
                            ...
                            <a href="result.html">
                                ...
                                <div class="fixture-row-right">
                                    <div>2</div>Pariatur FC</div>
                            </a>
                        </div>
                        </div>
                        <div>
                            <div class="sidebarbox-title">
                                <h3>Fixture and Results / 2011-2012</h3>
                            </div>
                        <!-- TABLE -->
                        <div class="fixture-row">
                            <a href="result.html">
                            ...
                            <a href="result.html">
                                ...
                                <div class="fixture-row-right">
                                    <div>3</div>Pariatur FC</div>
                            </a>
                        </div>
                        </div>
                        <div>
                            <div class="sidebarbox-title">
                                <h3>Fixture and Results / 2010-2011</h3>
                            </div>
                        <!-- TABLE -->
                        <div class="fixture-row">
                            <a href="result.html">
                            ...
                            <a href="result.html">
                                ...
                                <div class="fixture-row-right">
                                    <div>2</div>Voluptate Cillum FC</div>
                            </a>
                            <a href="result.html">
                                <div class="fixture-row-left">Fabulas FC
                                    <div>5</div>
